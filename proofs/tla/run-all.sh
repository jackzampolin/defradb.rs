...
RUNS=(
  ...
  "MC_TwoStoreCounter_Red_DoubleApply.cfg MC_TwoStoreCounter.tla   RED"   # #4935: re-delivered delta merged twice w/o dedup -> double-apply (INV_NoDoubleApply)
  "MC_TwoStoreCounter_Green.cfg     MC_TwoStoreCounter.tla         GREEN" # unified RMW + merged-set dedup -> exact (no loss, no double)
