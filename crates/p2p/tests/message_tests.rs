...
#[test]
fn pushlog_request_matches_go_fxamacker_fixture() {
    // Generated by `go run ./testdata/gen_message_fixtures` from the Go
    // protocol field layout. This protects the unchanged PushLog wire shape
    // while ownership changes the payload from DAG blocks to one head hint.
    let fixture = hex::decode(concat!(
        "aa6756657273696f6e6e2f646566726164622f302e302e31694d6573736167654944",
        "666d73672d676f6853656e646572494467706565722d676f665075626b6579420102",
        "695369676e617475726542030465446f63494468626166792d646f63634349444301",
        "71aa6c436f6c6c656374696f6e49446f626166792d636f6c6c656374696f6e6743",
        "726561746f726b6469643a6b65793a7a476f65426c6f636b44a1617801"
    ))
    .unwrap();
    let request: PushLogRequest = decode_with_ciborium(&fixture);
    ...
    assert_eq!(encode_with_ciborium(&request), fixture);
}
...
fn test_decode_gossip_payload_from_cbor_request() {
    ...
    request.sender_id = "go-origin-peer".to_string();
    ...
    assert_eq!(decoded.source_peer_id.as_deref(), Some("go-origin-peer"));
}
