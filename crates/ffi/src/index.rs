...
///
/// **Note:** Encrypted indexes are not yet supported in the Rust implementation.
/// This function returns an error indicating the feature is not available.
///
/// # Arguments
///
/// * `node_ptr` - Handle to the node
/// * `identity_did` - DID of the identity performing the operation
/// * `collection_name` - Name of the collection
/// * `field_name` - Name of the field to create encrypted index on
///
/// # Returns
///
/// Error indicating encrypted indexes are not supported.
///
/// # Safety
///
/// All string pointers must be valid null-terminated UTF-8 strings.
...
pub unsafe extern "C" fn create_encrypted_index(
    ...
    FfiResult::error("encrypted indexes are not yet supported in the Rust implementation")
}
...
/// * `identity_did` - DID of the identity performing the operation
/// * `collection_name` - Name of the collection
/// * `field_name` - Name of the field to delete encrypted index from
///
/// # Returns
///
/// Error indicating encrypted indexes are not supported.
...
///
/// **Note:** Encrypted indexes are not yet supported in the Rust implementation.
/// This function returns an empty JSON array since no encrypted indexes can exist.
///
/// # Arguments
///
/// * `node_ptr` - Handle to the node
...
/// # Returns
///
/// Empty JSON array `[]` (no encrypted indexes exist).
///
/// # Safety
///
/// `collection_name` must be a valid null-terminated UTF-8 string.
...
pub unsafe extern "C" fn list_encrypted_indexes(
    ...
    // Return empty array since no encrypted indexes can exist
...
///
/// **Note:** Encrypted indexes are not yet supported in the Rust implementation.
/// This function returns an empty JSON object since no encrypted indexes can exist.
///
/// # Arguments
///
/// * `node_ptr` - Handle to the node
/// * `identity_did` - DID of the identity performing the operation (may be null)
///
/// # Returns
///
/// Empty JSON object `{}` (no encrypted indexes exist).
#[no_mangle]
pub unsafe extern "C" fn list_all_encrypted_indexes(
    _node_ptr: usize,
    _identity_did: *const c_char,
) -> FfiResult {
    // Return empty object since no encrypted indexes can exist
    FfiResult::success("{}".to_string())
}
