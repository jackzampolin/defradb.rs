...
//!
//! On native targets, these require Send + Sync (multi-threaded).
//! On wasm32, these are no-ops (single-threaded).
...
/// A boxed future that is Send on native targets but not on wasm32.
#[cfg(not(target_arch = "wasm32"))]
