...
impl<S: Store> DB<S> {
    ...
    // NOTE: Collection operations (load_collections, create_collection*, delete_collection*,
    // truncate_collection*, list_collections*, get_collection*, has_collection*,
    // find_collection_by_id, set_active_collection_version, get_all_collection_versions,
    // collection_has_data) are now in collection_ops.rs
