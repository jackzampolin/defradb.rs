...
fn parse_positive_retention_nanos(raw: &str) -> std::result::Result<i64, String> {
    let nanos = parse_go_duration_nanos(raw)?;
    if nanos <= 0 {
...
fn source_sample_retention_time_nanos(sample: &SourceSample) -> Result<i64> {
