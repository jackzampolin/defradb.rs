...
fn the_sample_never_exceeds_its_byte_budget() {
    ...
    let mut corpus = crate::support::Corpus::new(0x5EED);
...
fn a_short_stream_is_kept_whole() {
    ...
    let mut corpus = crate::support::Corpus::new(11);
...
fn the_same_seed_draws_the_same_sample() {
    let draw = |seed: u64| {
        ...
        let mut corpus = crate::support::Corpus::new(21);
...
fn the_sample_is_drawn_from_the_whole_stream() {
    ...
    let mut corpus = crate::support::Corpus::new(33);
