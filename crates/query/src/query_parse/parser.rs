...
use super::explain::{check_field_explain_directive, parse_explain_directive};
...
pub fn parse_request_with_variables(
    ...
    let doc: Document<'_, String> = graphql_parser::parse_query(query)
        .map_err(|e| QueryError::parse(format!("Syntax Error GraphQL: {}", e)))?;
